...
import { AssignVehiclePayload, PersonOption, VehicleAssignment } from '../models/assignment.model';
 ...
 * gestionar el responsable asignado, sin que `features/vehicles` tenga que
 * importar nada de `features/persons`.
 */
